...
// Configure CORS
const corsOptions = {
  origin: ['http://localhost:5173', 'http://localhost:5174','https://extraordinary-gaufre-2fb3ba.netlify.app','https://incandescent-torrone-891930.netlify.app', process.env.FRONTEND_URL].filter(Boolean),
  credentials: true,
